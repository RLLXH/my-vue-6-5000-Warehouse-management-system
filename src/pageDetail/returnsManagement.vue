  ...
  <div>
    ...
    <el-table :data="dataList" style="width: 100%" border>
      ...
      <el-table-column label="操作" width="180">
        ...
        <el-table-column label="退货单号" prop="name"></el-table-column>
        <el-table-column label="退货类型" prop="name"></el-table-column>
        <el-table-column label="状态" prop="name"></el-table-column>
        <el-table-column label="收货仓库" prop="name"></el-table-column>
        <el-table-column label="退货数量" prop="name"></el-table-column>
        <el-table-column label="退货时间" prop="name"></el-table-column>
           <el-table-column label="退货方式" prop="name"></el-table-column>
    </el-table>
  </div>
</template>
<script>
