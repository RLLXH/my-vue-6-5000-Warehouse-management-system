  ...
  <div>
    ...
    <el-table :data="dataList" style="width: 100%" border>
      ...
      <el-table-column label="操作" width="180">
        ...
        <el-table-column label="商品编号" prop="name"></el-table-column>
        <el-table-column label="商类类别" prop="name"></el-table-column>
        <el-table-column label="价格类型" prop="name"></el-table-column>
